...
namespace Redux.Game_Server
{
    public class Player : Entity
    {
        ...
        public bool AddItem(ConquerItem item)
        {
            ...
            bool hasSpace = count < 40;
            bool doesNotContain = !Inventory.ContainsKey(item.UniqueID);
            return hasSpace && doesNotContain && Inventory.TryAdd(item.UniqueID, item);
        }
        #endregion
        ...
        public void On_Player_Timer()
        {
            ...
            if(CombatManager == null)
            {
                ...
                Console.WriteLine(Name + " has a combat manager.");
            }
