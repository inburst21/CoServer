...
namespace Redux
{
    public static class Commands
    {
        ...
        private static void Process_ClearInv(Player client, string[] command)
        {
            client.Inventory.Clear();
            client.SendMessage("Inv Cleared. Size " + client.Inventory.Count);
        }
        ...
        private static void Process_Scroll(Player client, string[] command)
        {
