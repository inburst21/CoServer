...
namespace Redux
{
    public static class Constants
    {
        ...
        public const int EXP_RATE = 5 * RATE_MULTI,
                              PROF_RATE = 5 * RATE_MULTI,
                              SKILL_RATE = 5 * RATE_MULTI,
                              GOLD_RATE = 5 * RATE_MULTI;

        public const double SOCKET_RATE = .4 * RATE_MULTI,
            CHANCE_REFINED = 10.0 * RATE_MULTI,
            CHANCE_UNIQUE = 6.0 * RATE_MULTI,
            CHANCE_ELITE = 1.0 * RATE_MULTI,
            CHANCE_SUPER = 0.3 * RATE_MULTI,
            CHANCE_PLUS = 2.0 * RATE_MULTI,
            CHANCE_METEOR = 0.72,
            CHANCE_DRAGONBALL = 0.0556 * RATE_MULTI,
            CHANCE_POTION = 4 * RATE_MULTI,
            CHANCE_REFINED_GEM = 10 * RATE_MULTI,
            CHANCE_SUPER_GEM = 1 * RATE_MULTI;
